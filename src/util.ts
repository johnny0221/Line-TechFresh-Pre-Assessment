...
export const questionResponse: types.QuestionResponse = {
    en: {
        ...
        whyLine: `1⃣ Why Line ?\n\n1. Robust and Innovative\n\nLine has been dedicated in building modern tech services since it was founded. Unlike some of the big tech companies that do not challenge themselves, Line on the otherhand is willing to use the most modern technologies to build innovative services year by year and that's one of the reason I want to Join Line.\n\n2. Build applications that people around me can use it\n\nMost of the people around me are using the services that Line offers, for example Line pay, for me, I think it is an honor to develop something that people around me are using !\n\n\n2⃣ What I can bring for Line ?\n\n1. English Ability\n\nWhen working in Line, collaborating with other developers in different countries using English must be inevitable, further more, I can also help Line promote its latest services and features to western countries.\n\n2. Self taught and Passionate\n\nI think \'learn by yourself\' is definitely important when you start to work, I am able to adapt the culture quickly and always have a passionate heart to learn new things.`,
    ...
    ch: {
        ...
        whyLine: `1⃣ 為什麼想進入Line？\n\n1. 穩健及創新\n\n就我個人的職涯規劃，我希望我能終身在一間成長性高且成熟的跨國科技公司工作，Line是一間橫垮許多國家的企業，且已經開發出許多實用的服務，從單純的一個通信軟體進化現在有許多不同種類的服務是我佩服Line的原因之一。\n\n2. 打造一個周邊的人都在使用的系統\n\n身邊的人都有使用Line的服務，身為一位開發人員，我希望可以加入Line來使用最現代的科技來該發一個能讓我身邊的人都在使用的Line產品。\n\n2⃣ 我可以為Line帶來什麼？\n\n1. 英文能力\n\nLine是一間跨國公司，我相信在職場上使用英文與其他國家的Line developers溝通是無法避免的，我對我的英語口說能力相當有自信，我相信我也能幫助推廣Line的各種產品以及服務到西方國家。\n\n2. 自學能力以及熱情的態度\n\n我是主要是一個自學的開發者，我認為我是一個學習能力快速並且願意接受新技術，我相信我能在Line接受以及跳戰各種任務。`,
        personality: `子洋有一顆正面的心且也願意接受來自各方面的挑戰，他喜歡在台上主持且與他人互動，但有時候太high會有點失去控制...`,
